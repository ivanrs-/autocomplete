...
function ControlsMapping() {
    ...
    [
        [
            [
                { id:'Description', objective: 1, options: [ "Discovery-ObjDesc 1", "Discovery-ObjDesc 2", "Discovery-ObjDesc 3"]},
                { id:'Description', objective: 2, options: [ "Service-ObjDesc 1", "Service-ObjDesc 2", "Service-ObjDesc 3"]},
                { id:'Description', objective: 3, options: [ "Value...ObjDesc 1", "Value...ObjDesc 2", "Value...ObjDesc 3"]},
                { id:'Description', objective: 4, options: [ "Category-ObjDesc 1", "Category-ObjDesc 2", "Category-ObjDesc 3"]},
                { id:'Description', objective: 5, options: [ "Prospecting-ObjDesc 1", "Prospecting-ObjDesc 2", "Prospecting-ObjDesc 3"]}
            ], 
        ...
        [
            [
                { id: 'Next Visit Obj(s)', objective: 1, options: [ "Discovery-NextVisit 1", "Discovery-NextVisit 2", "Discovery-NextVisit 3" ]},
                { id: 'Next Visit Obj(s)', objective: 2, options: [ "Service-NextVisit 1", "Service-NextVisit 2", "Service-NextVisit 3" ]},
                { id: 'Next Visit Obj(s)', objective: 3, options: [ "Value...-NextVisit 1", "Value...-NextVisit 2", "Value...-NextVisit 3" ]},
                { id: 'Next Visit Obj(s)', objective: 4, options: [ "Category-NextVisit 1", "Category-NextVisit 2", "Category-NextVisit 3" ]},
                { id: 'Next Visit Obj(s)', objective: 5, options: [ "Prospecting-NextVisit 1", "Prospecting-NextVisit 2", "Prospecting-NextVisit 3" ]}
            ], 
